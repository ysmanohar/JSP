...
div.relative {
	...
	<body>
		<!---strat-wrap----->
			...
			<!---End-header----->
			<!--start-image-slider---->
                        <h3 style="text-align: center"><pb> Fill details to Retain Password </pb></h3>
                        <br>
                          ...
                          <div class="relative">
                                <div>
                                  <form action="ControllerServlet" method="post" onsubmit="return myFunction()">
                                    ...
                                    <input type="text" id="fname" name="email" required="required" placeholder="Enter Name">
                                    <br> 
                                    <p>
                                        <br>
                                    <label for="lname"><b>First Name</b></label>  <br>
                                    <input type="text" id="lname" name="firstname" required="required" placeholder="Enter Firstname">
                                    <br>
